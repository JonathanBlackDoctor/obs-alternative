...
```
**AC 체크리스트**
- [ ] 9px 박스 색상이 StreamState와 동기화, 클릭 통과
- [ ] 전역 단축키로 UI 토글
- [ ] 오디오 슬라이더/마이크 드롭다운 실시간 반영
- [ ] 녹화 패널에 현재 파일·용량·남은 디스크 표시
- [ ] 로그 뷰어 최근 1000줄
...
**AC 체크리스트**
- [ ] 재부팅 시 자동 송출+녹화 시작
- [ ] 네트워크 차단/복구 시 자동 재연결, **녹화 무중단**
- [ ] 종료 시 mp4 정상 마감 + complete 전이
...
```
**AC 체크리스트**
- [ ] 인스톨러: 자동 시작 방식·녹화 폴더 선택, 동의 화면, FFmpeg 번들
- [ ] Squirrel 자동 업데이트 동작
- [ ] E2E: 클린 설치→재부팅→전 기능 동작
- [ ] 제거 시 자동 시작 항목·잔여 정리
